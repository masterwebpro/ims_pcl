...
function populateCity(value, city_id, type) {

    $.ajax({
        url: BASEURL + 'locations/cities',
        method: 'get',
        data: {"province_id": value},
        dataType: 'json',
        success: function(response){
            // Remove options
            $('#'+type+'cities').find('option').not(':first').remove();
            // Add options
            $.each(response,function(index,data){
                var sel = (city_id == +data['id']) ? 'selected' : '';
                $('#'+type+'cities').append('<option '+sel+' value="'+data['id']+'">'+data['city_name']+'</option>');
            });
        }
    });

    $('#'+type+'barangays').html('');
    $('#'+type+'barangays').append('<option value="">Select Barangay</option>');
}

function populateBarangay(value, barangay_id, type) {

    $.ajax({
        url: BASEURL + 'locations/barangays',
        method: 'get',
        data: {city_id: value},
        dataType: 'json',
        success: function(response){
            // Remove options
            $('#'+type+'barangays').find('option').not(':first').remove();
            // Add options
            $.each(response,function(index,data){
                var sel = (barangay_id == +data['id']) ? 'selected' : '';
                $('#'+type+'barangays').append('<option '+sel+' value="'+data['id']+'">'+data['barangay_name']+'</option>');
            });
        }
    });
}
...
function populateStore(client_id, store_id, container) {
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            // Add options
            $.each(response,function(index,data){
                var sel = (store_id == data['id']) ? 'selected' : '';
                $('#'+container).append('<option '+sel+' value="'+data['id']+'">'+data['store_name']+'</option>');
            });
        }
    });
}

function populateWarehouse(store_id, warehouse_id, container) {
    ...
    $.ajax({
        url: BASEURL + 'settings/getWarehouse',
        method: 'get',
        ...
        success: function(response){
            ...
            // Add options
            $.each(response,function(index,data){
                var sel = (warehouse_id == data['id']) ? 'selected' : '';
                $('#'+container).append('<option '+sel+' value="'+data['id']+'">'+data['warehouse_name']+'</option>');
            });
        }
    });
}

function populateLocation(container, warehouse_id, value) {
	$.ajax({
        ...
        success: function(response){
			...
			// Add options
            $.each(response,function(index,data){
				var sel = (value == data['storage_location_id']) ? 'selected' : '';
                $('#'+container).append('<option '+sel+' value="'+data['storage_location_id']+'">'+data['location']+'</option>');
            });
			$('#'+container).append('<option value="ra">Receiving Area</option>');
        }
    });
}
...
function stringToFloat(value)  {
	return  parseFloat(Number(value.replace(/[^0-9\.-]+/g,"")));
}
...
function populateBrand(category_id,brand_id) {
    $.ajax({
        ...
        success: function(response){
            ...
            // Add options
            $.each(response,function(index,data){
                var sel = (brand_id == data['category_brand_id']) ? 'selected' : '';
                $('#brand').append('<option '+sel+' value="'+data['category_brand_id']+'" data-catbrand="'+ data['category_brand_id'] +'">'+data['brand_name']+'</option>');
            });
        }
    });
}
...
function getAttributeEntity(attribute_id) {
    var result = false;
    $.ajax({
        url: BASEURL + 'settings/getEntity',
...
function getCategoryAttribute(category_id) {
    var result = false;
    $.ajax({
        url: BASEURL + 'settings/getCategoryAttribute',
        data: {"category_id": category_id},
        method: 'get',
        dataType: 'json',
        async: false,
...
function getProductAttribute(product_id) {
    var result = false;
    $.ajax({
        url: BASEURL + 'settings/getProductAttribute',
...
function populateLevel(warehouse_id, rack, layer) {
    $.ajax({
        url: BASEURL + 'settings/getLevel',
        method: 'get',
        data: {"rack": rack, "warehouse_id": warehouse_id},
        dataType: 'json',
        success: function(response){
			// Remove options
            $('#layer').find('option').not(':first').remove();
            // Add options
            $.each(response,function(index,data){
                var sel = (layer == data['level']) ? 'selected' : '';
                $('#layer').append('<option '+sel+' value="'+data['level']+'">'+data['level']+'</option>');
            });
        }
    });
}

function getNewLocation(warehouse_id) {
    var result = false;
    $.ajax({
...
function populateTruckType(vehicle_code="") {
    $.ajax({
        url: BASEURL + 'settings/getTruckType',
        method: 'get',
        dataType: 'json',
        success: function(response){
			// Remove options
            $('.truck_type').find('option').not(':first').remove();
            // Add options
            $.each(response,function(index,data){
                var sel = (vehicle_code == data['vehicle_code']) ? 'selected' : '';
                $('.truck_type').append('<option '+sel+' value="'+data['vehicle_code']+'">('+data['vehicle_code']+') '+data['vehicle_desc']+'</option>');
            });
        }
    });
}
...
function _encode(value) {
	var result;
    result = $.ajax({
        url: BASEURL + 'settings/_encode/'+value,
        method: 'get',
		dataType: "html",
        async: false,
        success: function(res){
...
function populatePlateNo(plate_no="") {
    var result = false;
    $.ajax({
        url: BASEURL + 'settings/getPlateNo',
        method: 'get',
