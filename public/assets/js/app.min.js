...
function populateStore(client_id, store_id) {
    $.ajax({
        ...
        success: function(response){
            ...
            $.each(response,function(index,data){
                ...
                $('#store').append('<option '+sel+' value="'+data['id']+'">'+data['store_name']+'</option>');
            });
        }
    });
}

function populateWarehouse(store_id, warehouse_id) {
    $.ajax({
        ...
        success: function(response){
            ...
            $.each(response,function(index,data){
                ...
                $('#warehouse').append('<option '+sel+' value="'+data['id']+'">'+data['warehouse_name']+'</option>');
            });
        }
    });
}
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $.each(response,function(index,data){
                ...
                $('#'+container).append('<option '+sel+' value="'+data['id']+'">'+data['location']+'</option>');
            });
        }
    });
}
...
function populateBrand(category_id,brand_id) {
    $.ajax({
        ...
        success: function(response){
            ...
            // Add options
            $.each(response,function(index,data){
                console.log(brand_id, data['category_brand_id'])
