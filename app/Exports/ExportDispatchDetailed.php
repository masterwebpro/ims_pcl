    ...
    */
    public function collection()
    {
        $data_list = DispatchDtl::select(
                ...
                'dh.driver',
                'dh.helper',
                DB::raw('DATE_FORMAT(dh.start_picking_datetime, "%H:%i") as start_picking_datetime'),
                DB::raw('DATE_FORMAT(dh.finish_picking_datetime, "%H:%i") as finish_picking_datetime'),
                DB::raw('DATE_FORMAT(dh.arrival_datetime, "%H:%i") as arrival_datetime'),
                DB::raw('DATE_FORMAT(dh.start_datetime, "%H:%i") as start_datetime'),
                DB::raw('DATE_FORMAT(dh.finish_datetime, "%H:%i") as finish_datetime'),
                DB::raw('DATE_FORMAT(dh.depart_datetime, "%H:%i") as depart_datetime'),
                'p.product_code',
                'p.product_name',
                'wd.inv_qty',
                'dispatch_dtl.qty',
