            ...
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <a href="#" class="submit-master-xls btn btn-secondary btn-label rounded-pill end-0"><i class="ri-file-excel-line label-icon align-middle rounded-pill fs-16 me-2"></i>Export to Excel</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="input-light">
                                    <select class="form-select" name="filter_date" id="filter_date">
                                        ...
                                        <option <?=($request->filter_date == 'received_date') ? 'selected': ''?> value="received_date">Received Date</option>
                            ...
                            <? if($master_list->total() > 0 ) : ?>
                                <? foreach($master_list as $master) :?>
                                    <tr>
                                        ...
                                        <td class="store text-end">{{ number_format($master->inv_qty,2) }}</td>
                                        <td class="store">{{ $master->ui_code}}</td>
                                        <td class="store text-end">{{ number_format($master->whse_qty,2) }}</td>
                                        <td class="store">{{ $master->uw_code}}</td>
                                        <td class="store text-end">{{ number_format($master->reserve_qty,2) }}</td>
