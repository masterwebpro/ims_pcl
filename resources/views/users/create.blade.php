        ...
        <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" data-bs-toggle="tab" href="#nav-border-user-access" role="tab" aria-selected="false" tabindex="-1">
                    <i class="ri-key-fill align-middle me-1"></i>User Access Menu
                </a>
            </li>
                    ...
                    <div class="col-9">
                        <div class="row g-3">
                            <div class="col-3">
                                ...
                                <input type="hidden" id="image_path" value="<?#=$avatar?>">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-3">
                                ...
                                <p class=" mb-2">
                                    <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="" placeholder="Mobile Number">
                            ...
                            <div class="col-3">
                                ...
                                <p class="mb-2">
                                    <input type="text" class="form-control" id="position" name="position" value="" placeholder="Postion">
                    ...
                    <div class="col-3 ">
                        <form action="" id="avatar_user_upload" method="POST" enctype="multipart/form-data">
                            <div class="profilepic">
                                <img class="profilepic-image" src="{{ isset($avatar) ? $avatar : 'https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg' }}" width="200" height="200" alt="profile_picture" />
                ...
                <div class="row mb-2">
                    <div class="col">
                        <div class="form-floating mb-1">
                            <input type="email" class="form-control" value="" id="email_address" placeholder="Email Address" autocomplete="off">
                ...
                <div class="row mb-2 {{ ($is_create) ? 'd-none': '' }}">
                    <div class="col-6">
                        <div class="form-check">
                            <input class="form-check-input is_edit_password" type="checkbox" value="" id="is_edit_password" checked autocomplete="off" >
