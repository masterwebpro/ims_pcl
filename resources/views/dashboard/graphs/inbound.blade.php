...
<div class="card">
    <div class="card-header border-0 align-items-center d-flex">
        <h4 class="card-title mb-0 flex-grow-1">Inbound <span class="badge bg-success text-uppercase" id="in-labels">Daily</span></h4>
        <div>
            <div class="mt-lg-0">
                <form action="javascript:void(0);">
                    <div class="row g-3 mb-0 align-items-center">
                        <div class="col-sm-auto">
                            <div class="input-group d-none" id="in-daily">
                                <input type="text"
                                ...
                                <button type="button" class="btn btn-primary" id="select-in-yearly">
                                    <i class="ri-globe-line align-bottom"></i> Yearly
                                </button>
                            </div>
                            <div class="input-group" id="in-yearly">
                                <input type="number"
                                    class="form-control" id="in-year" name="year" value="{{ date('Y') }}">
                                <button type="button" class="btn btn-primary" id="select-in-daily">
