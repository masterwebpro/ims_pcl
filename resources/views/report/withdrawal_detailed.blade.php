...
@slot('title') Withdrawal Detailed @endslot
@endcomponent
                        ...
                        <div class="card-body p-4 ">
                            <div class="row g-3">
                                <div class="col-lg-3 col-md-3">
                                    <h6 class="text-muted text-uppercase fw-semibold mb-3">Withdrawal #</h6>
                                    <p class="fw-medium mb-2">
                                        <input type="text" class="form-control" placeholder="Withdrawal No" name="rcv_no" id="wd_no" value="{{$request->wd_no}}">
                                        <span class="text-danger error-msg wd_no_error"></span>
                                     </p>
                                </div>
                                <div class="col-lg-3 col-md-3">
                            ...
                            <div class="row g-3 mt-1">
                                ...
                                <div class="col-lg-3 col-md-3">
                                    ...
                                    <p class=" mb-2">
                                        <select class="form-select select2" id="order_type" name="order_type">
                            ...
                            <div class="row mt-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="">
                                        <button class="submit-withdrawal-search btn btn-warning btn-label rounded-pill"><i class="ri-search-line label-icon align-middle rounded-pill fs-16 me-2"></i> Search</button>
                                        <a href="#" class="submit-withdrawal-xls btn btn-secondary btn-label rounded-pill"><i class="ri-file-excel-line label-icon align-middle rounded-pill fs-16 me-2"></i> Export to Excel</a>
                                        <a href="#" class="submit-withdrawal-print btn btn-primary btn-label rounded-pill"><i class="ri-printer-line label-icon align-middle rounded-pill fs-16 me-2"></i> Print Preview</a>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
