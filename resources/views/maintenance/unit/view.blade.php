            ...
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                        <a href="{{ URL::to('maintenance/unit') }}/<?=_encode($uom->uom_id)?>/edit" class="btn btn-success btn-label rounded-pill"><i class="ri-edit-line label-icon align-middle rounded-pill fs-16 me-2"></i> Edit</a>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-4">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" disabled name="code" id="code" value="{{ $uom->code }}" placeholder="Enter Code">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" name="uom_desc" disabled id="uom_desc" value="{{ $uom->uom_desc }}" placeholder="Enter Description">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" id="convertion_pc" required="required"  name="convertion_pc" disabled class="form-control" value="{{ $uom->convertion_pc }}" placeholder="Enter Conversion">
