                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-select select2 truck_type" required="required" id="vehicle_type" name="vehicle_type[]" disabled >
                                        ...
                                        <option value="<?=$truck->vehicle_code?>" <?=($truck->vehicle_code == $trucker->vehicle_type) ? 'selected' : ''?> ><?="(".$truck->vehicle_code.") ".$truck->vehicle_desc?></option>
                                        <? endforeach;?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" id="plate_no" required="required"  name="plate_no" disabled class="form-control" value="{{ $trucker->plate_no }}" placeholder="Enter Conversion">
                                </div>
                            </div>
                        </div>
