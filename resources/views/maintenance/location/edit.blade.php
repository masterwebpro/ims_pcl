...
@slot('title') Storage Location > Edit @endslot
@endcomponent
                            ...
                            <div class="row mb-4 mx-3">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <div class="form-check form-switch form-switch-custom form-switch-primary">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="is_enabled" role="switch" id="is_enabled" <?=($location->is_enabled == 1) ? 'checked' : ''?> >
                                    </div>
                                </div>
