...
@slot('title') Storage Location > View @endslot
@endcomponent
    ...
    <div class="col-xxl-11">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Storage Location - View</h4>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-4 mx-3">
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-select select2 disabled" disabled required="required" id="client" name="client">
                                        <option value="">Select Client</option>                                                            
                                        <? foreach($client_list as $client) : ?>
                                            <option value="<?=$client->id?>" <?=($location->warehouse->client->id == $client->id) ? 'selected': ''?> ><?=$client->client_name?></option>
                                        <? endforeach;?>
                                    </select>
                            ...
                            <div class="row mb-4 mx-3">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="form-check form-switch form-switch-custom form-switch-primary">
                                        ...
                                        <input class="form-check-input" type="checkbox" disabled name="is_enabled" role="switch" id="is_enabled" <?=($location->is_enabled == 1) ? 'checked' : ''?> >
                                    </div>
                                </div>
