            ...
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                        <a href="{{ URL::to('maintenance/warehouse') }}/<?=_encode($warehouse->id)?>/edit" class="btn btn-success btn-label rounded-pill"><i class="ri-edit-line label-icon align-middle rounded-pill fs-16 me-2"></i> Edit</a>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4 offset-md-8 form-group">
                                    <div class="form-check form-switch form-switch-custom form-switch-primary float-end">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch" id="is_enabled" name="is_enabled" disabled {{ (($warehouse->is_enabled == 1) ? "checked" : "") }}>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" name="warehouse_name" id="warehouse_name" disabled value="{{ $warehouse->warehouse_name }}" placeholder="Enter Warehouse Name">
