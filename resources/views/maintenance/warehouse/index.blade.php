    ...
    <div class="col-lg-12">
        <div class="card" id="tasksList">
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ URL::to('maintenance/warehouse/create') }}"class="btn btn-danger add-po" ><i class="ri-add-line align-bottom me-1"></i> Create Warehouse</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                        ...
                        <tbody class="list form-check-all">
                            <? if($warehouse->total() > 0 ) : ?>
                                <? foreach($warehouse as $wh) :?>
                                    <tr>
                                        <td class="warehouse_name">{{ $wh->warehouse_name}}</td>
                                        <td class="client_name">{{ $wh->client_name}}</td>
                                        <td class="store_name">{{ $wh->store_name}}</td>
                                        <td>
                                        ...
                                        <td class="action">
                                            <div class="hstack gap-3 fs-12">
                                                ...
                                                <a href="{{ URL::to('maintenance/warehouse') }}/<?=_encode($wh->id);?>/edit" data-id="{{$wh->id}} " class="link-info edit-po"><i class="ri-pencil-fill align-bottom me-1"></i> Edit </a> </div>
                                        </td>
                                    </tr>
                                <? endforeach; ?>
                            <? else :?>
                ...
                <!-- Pagination -->
                {!! $warehouse->withQueryString()->links('pagination::bootstrap-5') !!}
            </div>
            <!--end card-body-->
        </div>
        <!--end card-->
