            ...
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ URL::to('maintenance/supplier/create') }}"class="btn btn-danger add-po" ><i class="ri-add-line align-bottom me-1"></i> Create Supplier</a>
                    </div>
                </div>
            </div>
                        ...
                        <tbody class="list form-check-all">
                            <? if($supplier->total() > 0 ) : ?>
                                <? foreach($supplier as $sup) :?>
                                    <tr>
                                        <td class="id">{{ $sup->supplier_name}}</td>
                                        ...
                                        <td class="action">
                                            <div class="hstack gap-3 fs-12">
                                                ...
                                                <a href="{{ URL::to('maintenance/supplier') }}/<?=_encode($sup->id);?>/edit" data-id="{{$sup->id}} " class="link-info edit-po"><i class="ri-pencil-fill align-bottom me-1"></i> Edit </a> </div>
                                        </td>
                                    </tr>
                                <? endforeach; ?>
                            <? else :?>
