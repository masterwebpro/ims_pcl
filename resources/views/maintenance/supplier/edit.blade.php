                                ...
                                <div class="col-md-12">
                                    <div class="row mb-4">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="id" id="id" value="{{  $supplier->id }}">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" id="contact_no" required="required"
                                                name="contact_no" class="form-control" value="{{ $supplier->contact_no }}"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-8 form-group">
                                            <div>
                                                ...
                                                <textarea class="form-control" id="address" rows="3" placeholder="Enter address...">{{ $supplier->supplier_address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
