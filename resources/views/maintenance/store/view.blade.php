                ...
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                            <a href="{{ URL::to('maintenance/store') }}/<?=_encode($store->id)?>/edit" class="btn btn-success btn-label rounded-pill"><i class="ri-edit-line label-icon align-middle rounded-pill fs-16 me-2"></i> Edit</a>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" class="form-control" required="required"
                                                name="store_name" id="store_name" value="{{ $store->store_name }}" placeholder="Enter Name" disabled>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label for="store_code" class="form-label">Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required"
                                                name="store_code" id="store_code" value="{{ $store->store_code }}" placeholder="Enter Code" disabled>
                                        ...
                                        <div class="col-md-2">
                                            <label for="tin" class="form-label">Tin <span
                                                class="text-danger">*</span></label>
                                                <input type="text" class="form-control" required="required"
                                                    name="tin" id="tin" value="{{ $store->tin }}" placeholder="Enter Tin" disabled>
                                        ...
                                        <div class="col-md-2 mt-4">
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_enabled" {{ $store->is_enabled == 1 ? "checked" : "" }} disabled>
                                            </div>
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                <label class="form-check-label" for="is_vatable">Vatable</label>
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_vatable" {{ $store->is_vatable == 1 ? "checked" : "" }} disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="(xxx)xxx-xxxx" value="{{ $store->phone_no }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                <label for="address_1" class="form-label">Address 1<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="address_1" name="address_1" value="{{ $store->address_1 }}" placeholder="Enter address..." disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="address_2" name="address_2" value="{{ $store->address_2 }}" placeholder="Enter address..." disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
