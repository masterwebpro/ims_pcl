                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-check form-switch form-switch-primary form-switch-lg"
                                    dir="ltr">
                                    <input type="checkbox" class="form-check-input" id="is_serialize"  <?=($product->is_serialize == 1) ? 'checked' : '' ?> disabled
                                        name="is_serialize">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="url" class="form-control" id="product_upc" readonly
                            ...
                            <div class="col-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="url" class="form-control" id="product_name" readonly
                            ...
                            <div class="col-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="url" class="form-control" id="product_sku" readonly
                            ...
                            <div class="col-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-select select2" required="required"  data-brand="{{ $prod_category->category_brand_id }}" disabled
