                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-2 mt-4">
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_enabled" {{ $client->is_enabled == 1 ? "checked" : "" }}>
                                            </div>
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                <label class="form-check-label" for="is_vatable">Vatable</label>
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_vatable" {{ $client->is_vatable == 1 ? "checked" : "" }}>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="(xxx)xxx-xxxx" value="{{ $client->phone_no }}">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="address_2" name="address_2" value="{{ $client->address_2 }}" placeholder="Enter address...">
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
