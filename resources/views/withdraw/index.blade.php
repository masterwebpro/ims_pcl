...
@section('content')
                ...
                <div class="card-header border-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <button data-status="open" class="create-withdrawal btn btn-success btn-label rounded-pill"><i
                                    class="ri-file-line label-icon align-middle rounded-pill fs-16 me-2"></i> Create
                                Withdrawal</button>
                            <button data-status="posted" class="withdraw-do btn btn-secondary btn-label rounded-pill"><i
                                    class="ri-download-line label-icon align-middle rounded-pill fs-16 me-2"></i> Withdraw
                                from DO</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-3 col-sm-6">
                                <div class="search-box">
                                    <input type="text" name="q" class="form-control search"
                                        placeholder="WD or Order Number"
                                        value="{{ isset($request->q) ? $request->q : '' }}">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="input-light">
                                    <select class="form-select" name="filter_date" id="filter_date">
                                        ...
                                        <option <?= $request->filter_date == 'withdraw_date' ? 'selected' : '' ?>
                                            value="withdraw_date">Withdrawal Date</option>
                                        <option <?= $request->filter_date == 'created_at' ? 'selected' : '' ?>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <input type="text" class="form-control" name="date" id="date_picker"
                                    ...
                                    value="{{ isset($request->date) ? $request->date : '' }}" data-range-date="true"
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <select class="form-select select2" id="deliver_to" name="deliver_to">
                                    ...
                                    <option value="<?= $del->id ?>"
                                        <?= $request->deliver_to == $del->id ? 'selected' : '' ?>><?= $del->client_name ?>
                                    </option>
                                    <? endforeach;?>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-3">
                                <div class="">
                                    <div class="">
                                        <button type="submit"
                                            class="submit-receive-search btn btn-warning btn-label rounded-pill"><i
                                                class="ri-search-line label-icon align-middle rounded-pill fs-16 me-2"></i>
                                            Search</button>
                                        <a href="#"
                                            class="submit-receive-xls btn btn-secondary btn-label rounded-pill d-none"><i
                                                class="ri-file-excel-line label-icon align-middle rounded-pill fs-16 me-2"></i>Excel</a>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
                        ...
                        <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                            <thead class="table-light text-muted">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="id">WD Date</th>
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    <td class="wd_no">
                                        <a href="{{ URL::to('withdraw') }}/<?= _encode($withdraw->id) ?>"
                                            data-id="{{ $withdraw->id }}" class="link-info text-info d-inline-block">
                                            {{ $withdraw->wd_no }}</a>
                                    </td>
                                    ...
                                    <td class="client_name">{{ $withdraw->customer_name }}</td>
                                    ...
                                    <td class="status"><span
                                            class="badge {{ $withdraw->status }} text-uppercase fs-11">{{ $withdraw->status }}</span>
                                    </td>
                                    <td class="action">
                                        <div class="hstack gap-3 fs-12">
                                            ...
                                            <a href="{{ URL::to('withdraw') }}/<?= _encode($withdraw->id) ?>/edit"
                                                data-id="{{ $withdraw->id }} " class="link-info edit-po"><i
    ...
    <div class="modal fade" id="show-do" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-footer">
                    <div class="hstack gap-2 justify-content-end">
                        <button type="button" class="btn btn-warning" data-bs-dismiss="modal"><i
                                class="ri-close-line label-icon align-middle rounded-pill fs-16 me-2"></i>Close</button>
                        <button type="button" id="withdraw-do-btn" class=" btn btn-success btn-label rounded-pill"><i
                                class="ri-add-line label-icon align-middle rounded-pill fs-16 me-2"></i> Select</button>
                    </div>
                </div>
            </div>
        </div>
