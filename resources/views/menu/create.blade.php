    ...
    <div class="col-xxl-10">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Brand Creation</h4>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-4">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" name="brand_name" id="brand_name" value="" placeholder="Enter Brand Name">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" class="form-control" required="required" name="sort_by" id="sort_by" value="" placeholder="Enter Sort by">
