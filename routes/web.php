...
Route::group(['prefix' => 'reports', 'middleware' => 'auth'], function () {
    ...
    Route::get('/export-dispatch-detailed',[App\Http\Controllers\ReportController::class,'exportDispacthDetailed'])->name('export-dispatch-detailed');
    Route::get('/print-dispatch-detailed',[App\Http\Controllers\ReportController::class,'printPdfDispatchDetailed'])->name('print-dispatch-detailed');
