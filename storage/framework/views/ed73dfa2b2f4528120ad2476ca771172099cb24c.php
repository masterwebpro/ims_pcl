    ...
    <div class="col-xxl-10">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Warehouse Edit</h4>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4 offset-md-8 form-group">
                                    <div class="form-check form-switch form-switch-custom form-switch-primary float-end">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch" id="is_enabled" name="is_enabled" <?php echo e((($warehouse->is_enabled == 1) ? "checked" : "")); ?>>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" name="warehouse_name" id="warehouse_name" value="<?php echo e($warehouse->warehouse_name); ?>" placeholder="Enter Warehouse Name">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-select select2" required="required" id="store_id" name="store_id">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\ims\resources\views/maintenance/warehouse/edit.blade.php ENDPATH**/ ?>