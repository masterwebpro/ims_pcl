        ...
        <div class="col-xxl-10">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Supplier Edit</h4>
                                ...
                                <div class="col-md-12">
                                    <div class="row mb-4">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="id" id="id" value="<?php echo e($supplier->id); ?>">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" id="contact_no" required="required"
                                                name="contact_no" class="form-control" value="<?php echo e($supplier->contact_no); ?>"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-8 form-group">
                                            <div>
                                                ...
                                                <textarea class="form-control" id="address" rows="3" placeholder="Enter address..."><?php echo e($supplier->supplier_address); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\ims\resources\views/maintenance/supplier/edit.blade.php ENDPATH**/ ?>