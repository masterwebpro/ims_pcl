                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" class="form-control" required="required"
                                                name="store_name" id="store_name" value="<?php echo e($store->store_name); ?>" placeholder="Enter Name">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label for="store_code" class="form-label">Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required"
                                                name="store_code" id="store_code" value="<?php echo e($store->store_code); ?>" placeholder="Enter Code">
                                        ...
                                        <div class="col-md-2">
                                            <label for="tin" class="form-label">Tin <span
                                                class="text-danger">*</span></label>
                                                <input type="text" class="form-control" required="required"
                                                    name="tin" id="tin" value="<?php echo e($store->tin); ?>" placeholder="Enter Tin">
                                        ...
                                        <div class="col-md-2 mt-4">
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_enabled" <?php echo e($store->is_enabled == 1 ? "checked" : ""); ?>>
                                            </div>
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                <label class="form-check-label" for="is_vatable">Vatable</label>
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_vatable" <?php echo e($store->is_vatable == 1 ? "checked" : ""); ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="(xxx)xxx-xxxx" value="<?php echo e($store->phone_no); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                <label for="address_1" class="form-label">Address 1<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="address_1" name="address_1" value="<?php echo e($store->address_1); ?>" placeholder="Enter address...">
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="address_2" name="address_2" value="<?php echo e($store->address_2); ?>" placeholder="Enter address...">
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('/assets/js/maintenance/store.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\ims\resources\views/maintenance/store/edit.blade.php ENDPATH**/ ?>