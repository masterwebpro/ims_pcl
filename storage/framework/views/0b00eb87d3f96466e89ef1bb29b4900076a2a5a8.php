                ...
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                            <a href="<?php echo e(URL::to('maintenance/client')); ?>/<?=_encode($client->id)?>/edit" class="btn btn-success btn-label rounded-pill"><i class="ri-edit-line label-icon align-middle rounded-pill fs-16 me-2"></i> Edit</a>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" class="form-control" required="required"
                                                name="client_name" id="client_name" value="<?php echo e($client->client_name); ?>" placeholder="Enter Name" disabled>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label for="client_code" class="form-label">Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required"
                                                name="client_code" id="client_code" value="<?php echo e($client->client_code); ?>" placeholder="Enter Code" disabled>
                                        ...
                                        <div class="col-md-2">
                                            <label for="tin" class="form-label">Tin <span
                                                class="text-danger">*</span></label>
                                                <input type="text" class="form-control" required="required"
                                                    name="tin" id="tin" value="<?php echo e($client->tin); ?>" placeholder="Enter Tin" disabled>
                                        ...
                                        <div class="col-md-2 mt-4">
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_enabled" <?php echo e($client->is_enabled == 1 ? "checked" : ""); ?> disabled>
                                            </div>
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                <label class="form-check-label" for="is_vatable">Vatable</label>
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_vatable" <?php echo e($client->is_vatable == 1 ? "checked" : ""); ?> disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" required="required" disabled
                                                name="contact_person" id="contact_person" value="<?php echo e($client->contact_person); ?>"
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label for="email_address" class="form-label">Email Address <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required" disabled
                                                name="email_address" id="email_address" value="<?php echo e($client->email_address); ?>"
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone_no" name="phone_no"  disabled placeholder="(xxx)xxx-xxxx" value="<?php echo e($client->phone_no); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="address_1" name="address_1" disabled value="<?php echo e($client->address_1); ?>" placeholder="Enter address...">
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="city" class="form-label">City<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required" disabled
                                                name="city" id="city" value="<?php echo e($client->city); ?>"
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label for="province" class="form-label">Province<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required" disabled
                                                name="province" id="province" value="<?php echo e($client->province); ?>"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="address_2" disabled name="address_2" value="<?php echo e($client->address_2); ?>" placeholder="Enter address...">
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="country" class="form-label">Country<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required"
                                                name="country" id="country" value="<?php echo e($client->country); ?>" disabled
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label for="zipcode" class="form-label">Zip Code<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required" disabled
                                                name="zipcode" id="zipcode" value="<?php echo e($client->zipcode); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\ims\resources\views/maintenance/client/view.blade.php ENDPATH**/ ?>