                        ...
                        <div class="col-md-12">
                            <div class="row mb-4">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" name="code" id="code" value="<?php echo e($uom->code); ?>" placeholder="Enter Code">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" name="uom_desc" id="uom_desc" value="<?php echo e($uom->uom_desc); ?>" placeholder="Enter Description">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" id="convertion_pc" required="required"  name="convertion_pc" class="form-control" value="<?php echo e($uom->convertion_pc); ?>" placeholder="Enter Conversion">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\ims\resources\views/maintenance/unit/edit.blade.php ENDPATH**/ ?>