        ...
        <div class="col-xxl-10">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Store Creation</h4>
                                ...
                                <div class="col-md-12">
                                    <div class="row mb-4">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" class="form-control" required="required"
                                                name="store_name" id="store_name" value="" placeholder="Enter Name">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label for="store_code" class="form-label">Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required"
                                                name="store_code" id="store_code" value="" placeholder="Enter Code">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <div class="invalid-feedback text-danger error-msg">Client is
                                                Required</div>
                                        </div>
                                        <div class="col-md-3 form-group">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\ims\resources\views/maintenance/store/create.blade.php ENDPATH**/ ?>