        ...
        <div class="col-xxl-10">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Client Edit</h4>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" class="form-control" required="required"
                                                name="client_name" id="client_name" value="<?php echo e($client->client_name); ?>" placeholder="Enter Name">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label for="client_code" class="form-label">Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required"
                                                name="client_code" id="client_code" value="<?php echo e($client->client_code); ?>" placeholder="Enter Code">
                                        ...
                                        <div class="col-md-2">
                                            <label for="tin" class="form-label">Tin <span
                                                class="text-danger">*</span></label>
                                                <input type="text" class="form-control" required="required"
                                                    name="tin" id="tin" value="<?php echo e($client->tin); ?>" placeholder="Enter Tin">
                                        ...
                                        <div class="col-md-2 mt-4">
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_enabled" <?php echo e($client->is_enabled == 1 ? "checked" : ""); ?>>
                                            </div>
                                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                                <label class="form-check-label" for="is_vatable">Vatable</label>
                                                <input class="form-check-input" type="checkbox" role="switch" id="is_vatable" <?php echo e($client->is_vatable == 1 ? "checked" : ""); ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="(xxx)xxx-xxxx" value="<?php echo e($client->phone_no); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                <label for="address_1" class="form-label">Address 1<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="address_1" name="address_1" value="<?php echo e($client->address_1); ?>" placeholder="Enter address...">
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 form-group">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="address_2" name="address_2" value="<?php echo e($client->address_2); ?>" placeholder="Enter address...">
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="country" class="form-label">Country<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" required="required"
                                                name="country" id="country" value="<?php echo e($client->country); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\ims\resources\views/maintenance/client/edit.blade.php ENDPATH**/ ?>