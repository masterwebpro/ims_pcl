...
<script src="<?php echo e(URL::asset('assets/libs/toastjs/toastr.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/js/plugins.min.js')); ?>"></script>
<?php echo $__env->yieldContent('script'); ?>
<?php echo $__env->yieldContent('script-bottom'); ?>
<?php /**PATH /Users/cris/Sites/PCL/ims/resources/views/layouts/vendor-scripts.blade.php ENDPATH**/ ?>