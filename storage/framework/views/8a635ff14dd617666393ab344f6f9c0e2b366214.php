<?php $components = app('App\Http\Controllers\ComponentsController'); ?>
<!-- ========== App Menu ========== -->
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index" class="logo logo-dark">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('assets/images/logo.png')); ?>" alt="1" height="60">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('assets/images/pcl_logo.png')); ?>" alt="2" height="60">
        ...
        <a href="index" class="logo logo-light">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('assets/images/logo.png')); ?>" alt="3" height="60">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('assets/images/pcl_logo.png')); ?>" alt="4" height="60">
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <?php $__currentLoopData = $components->listsidebar(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="nav-item">
                    <?
                        if(isset($_menu->submenu_names)){
                    ?>
                        <a class="nav-link menu-link" href="#side_menu_<?php echo e($_menu->menu_id); ?>" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="side_menu_<?php echo e($_menu->menu_id); ?>">
                            <i class="<?php echo e($_menu->icon); ?>"></i> <span><?php echo e($_menu->parent_menu); ?></span>
                        </a>
                        <div class="collapse menu-dropdown" id="side_menu_<?php echo e($_menu->menu_id); ?>">
                    ...
                    ?>
                            ...
                            <li class="nav-item">
                                <a href="<?=URL::to($arr_submenu[2]);?>" class="nav-link"><?php echo e($arr_submenu[1]); ?></a>
                            </li>
                    <?
                            }
                    ?>
                    ...
                    ?>
                        <a class="nav-link menu-link" href="#side_menu_<?php echo e($_menu->menu_id); ?>">
                            <i class="<?php echo e($_menu->icon); ?>"></i> <span><?php echo e($_menu->parent_menu); ?></span>
                        </a>
                    <?
                        }
...
<?php /**PATH /Users/cris/Sites/PCL/ims/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>